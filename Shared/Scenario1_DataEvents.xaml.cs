...
namespace Microsoft.Samples.Devices.Sensors.AccelerometerSample
{
    public sealed partial class Scenario1 : Page
    {
        ...
        String Coordinate_Z = String.Empty;
        String dataDetails = String.Empty;
        //string newFileName = string.Format(@"{0}_{1}.csv", DateTime.Now.ToString("yyyyMMddHHmmssfff"), "AccelerometerSensorData");
        string newFileName = "AccelerometerSensorData.csv";
        string NewDataFile = string.Empty;
        int i = 0;
        String Headers = "ID" +"," + "Coordinate_X" + "," + "Coordinate_Y" + "," + "Coordinate_Z";
       ...
       private async void ReadingChanged(object sender, AccelerometerReadingChangedEventArgs e)
        {
           ...
           CloudStorageAccount storageAccount = CloudStorageAccount.Parse("DefaultEndpointsProtocol=https;AccountName=yourazurestorageaccountname;AccountKey=yourazurestorageaccountkey");
